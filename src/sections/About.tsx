        ...
        >
          ...
          <motion.div className="flex flex-col items-start text-left" variants={itemVariants}>
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
              I'm Devesh Tripathi, a Gen AI Full Stack Developer and Web Developer Intern at Navigant Technologies. Skilled in MERN Stack, TypeScript, Redis, WebSockets, REST APIs, and AI integration, I focus on full-stack development, backend systems, and modern AI technologies. I enjoy building scalable applications and solving real-world problems through software development.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full mb-8">
              ...
              >
                ...
                <div>
                  ...
                  <h4 className="font-bold text-sm text-slate-800 dark:text-white mt-1">Master of Computer Applications</h4>
              ...
              >
                ...
                <div>
                  <span className="text-[10px] font-mono tracking-widest text-brand-purple block uppercase">2021 - 2024</span>
                  <h4 className="font-bold text-sm text-slate-800 dark:text-white mt-1">Bachelor of Computer Applications</h4>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 w-full py-8 border-t border-black/10 dark:border-white/10">
              ...
              >
                ...
                <div className="flex justify-between items-start gap-2">
                  <span className="text-[14px] sm:text-[15px] font-extrabold text-brand-indigo tracking-tight font-sans leading-tight uppercase">
                ...
                <div className="mt-3">
                  ...
                  <p className="text-[9px] text-brand-indigo dark:text-brand-cyan font-mono mt-0.5 font-semibold">
                    Jun 2026 – Present
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="flex justify-between items-start gap-2">
                  <span className="text-sm sm:text-base font-extrabold text-brand-purple tracking-tight font-sans leading-tight uppercase">
                    Tech Stack
                  </span>
                ...
                <div className="mt-3 flex flex-col gap-0.5 text-left">
                  ...
                  <p className="text-[9px] text-brand-purple dark:text-brand-cyan font-mono mt-0.5 font-bold">
                    Generative AI
                  </p>
                </div>
              </motion.div>
